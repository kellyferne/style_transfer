...
# get img_shape
def ffwd(data_in, paths_out, checkpoint_dir, my_checkpoint, device_t='/gpu:0', batch_size=4):
...
def ffwd_to_img(in_path, out_path, checkpoint_dir, my_checkpoint, device='/cpu:0'):
    paths_in, paths_out = [in_path], [out_path]
    ffwd(paths_in, paths_out, checkpoint_dir, my_checkpoint, batch_size=1, device_t=device)
...
def main():
    ...
    if not os.path.isdir(opts.in_path):
        ...
        ffwd_to_img(opts.in_path, out_path, opts.checkpoint_dir,opts.my_checkpoint,
                    device=opts.device)
    else:
